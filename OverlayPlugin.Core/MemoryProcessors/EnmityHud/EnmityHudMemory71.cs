...
{
    interface IEnmityHudMemory71 : IEnmityHudMemory { }

    class EnmityHudMemory71 : EnmityHudMemory, IEnmityHudMemory71
    {
        private const string enmityHudSignature = "488B8F????????488B01FF50??4C8B1D";
        private static readonly int[] enmityHudPointerPath = new int[] { 0x30, 0x58, 0xA8, 0x28 };
        ...
        public EnmityHudMemory71(TinyIoCContainer container)
